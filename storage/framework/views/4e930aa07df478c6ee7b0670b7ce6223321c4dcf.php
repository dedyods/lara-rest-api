...
<head>
 ...
 <!-- Custom fonts for this template -->
  ...
  <link href="<?php echo e(asset('sbadmin2/css/style.css')); ?>" rel="stylesheet">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div>
            ...
            <img src="<?php echo e(asset('sbadmin2/img/logo.png')); ?>" weidht="250px" height="70px">
          </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Dedy Setiawan</span>
                <img class="img-profile rounded-circle" src="https://images.unsplash.com/photo-1509897693578-e9237fb35e3f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80">
              </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy;Dedy Setiawan | No. BP: 17321033 |</span>
            <span>Upi YPTK Padang 2019 </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<?php /**PATH C:\xampp72\htdocs\tesis\resources\views/template.blade.php ENDPATH**/ ?>